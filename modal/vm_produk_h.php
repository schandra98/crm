                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <div class="form-group">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <input type="text" class="form-control" name="barang"  placeholder="PRODUCT" required="required" value="<?= $barang['PRODUCT_HEADER'] ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-xs-12">
                        <div class="form-group">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <input type="text" class="form-control" name="keterangan-barang"  placeholder="KETERANGAN"  value="<?= $barang['KETERANGAN'] ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-xs-12">
                ...
                <div class="form-group">
                    <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                        ...
                        <?php } else { ?>
                            ...
                            <a class="btn btn-danger pull-right" href="<?= base_url('Delete/deleteBarang/' . $barang["ID_PRODUCT_HEADER"]); ?>" onclick="return confirm('Are you sure to Delete?');"> <i class="fa fa-trash" ></i> Delete </a>
                        <?php } ?>
                    </div>
                </div>
            </form>
